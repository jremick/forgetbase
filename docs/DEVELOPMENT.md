...
npx -y pnpm@11.7.0 --filter @forgetbase/cli start -- auth api-key-create --user-id <reader-user-id> --name reader --scopes asset:read
npx -y pnpm@11.7.0 --filter @forgetbase/cli start -- auth api-key-create --service-account-id <service-account-id> --name automation --scopes agent:execute
