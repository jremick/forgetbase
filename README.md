...
- Postgres retrieval chunks with citation metadata, transparent lexical/vector/hybrid ranking metadata, admin-configurable tenant ranking weights, deterministic hash embeddings stored in `pgvector`, and provider-embedding-ready storage hooks
